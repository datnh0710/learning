...
/**
 * @author datnh0710
 * @created 11/04/2022 - 9:30 AM
 * @packege com.Class4401
 * @project java
 */
public class hw3_question_1 {
    private static int philosophersNumber = 4;
    private static Philosopher array_philos[] = new Philosopher[philosophersNumber];
    ...
    static class Philosopher extends Thread {
        ...
        public void take_fork(Fork fork, int dir, boolean br_rule) {
    ...
    public static void main(String argv[]) throws InterruptedException {
        ...
        for (int i = 0; i < philosophersNumber; i++) {
            array_philos[i] = new Philosopher(i, forks[i], forks[(i + philosophersNumber - 1) % philosophersNumber]);
            array_philos[i].start();
        }
        ...
        for (int i = 0; i < philosophersNumber; i++) {
            array_philos[i].join();
            total_eating += array_philos[i].getEating_time();
            total_thinking += array_philos[i].getThinking_time();
            total_waiting += array_philos[i].getWaiting_time();
        ...
        //Thread.sleep(65000);
        System.out.println(" Total Time eating:  " + (float)(total_eating/philosophersNumber));
        System.out.println(" Total Time Thinking:  " + (float)total_thinking/philosophersNumber);
        System.out.println(" Total Time waiting:  " + (float)total_waiting/philosophersNumber);
        System.exit(0);
    }
}
